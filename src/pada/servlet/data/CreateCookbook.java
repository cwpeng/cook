...
public class CreateCookbook extends HttpServlet{
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		request.setCharacterEncoding("utf-8");
		// 取得並驗證使用者輸入資訊
		if(request.getParameter("name")==null||request.getParameter("description")==null||request.getParameter("materials")==null){
			return;
		}else{
			...
			response.setHeader("result", pada.data.Cookbook.createCookbook(request.getParameter("name"), request.getParameter("description"), materials) + "");
		}
	}
}
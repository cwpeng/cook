...
public class ModifyGeometrySet extends HttpServlet{
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		if(request.getParameter("id")==null||request.getParameter("name")==null||request.getParameter("description")==null){
			...
			response.setHeader("result", pada.data.GeometrySet.modifyGeometrySet(Long.parseLong(request.getParameter("id")),
